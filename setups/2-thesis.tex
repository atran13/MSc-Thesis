...
\subtitle{A Machine Learning Approach with Streetview Imagery}
...
\keywords{gentrification, computer vision, street view imagery, storefront signage, scene-text analysis}
